    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-800">Edit Student Report</h1>
            <p className="text-slate-600 mt-2">Update progress report for {studentName}</p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-4 pt-4">
              <Button
                ...
                onClick={() => router.back()}
                variant="outline"
                className="bg-white py-6 rounded-xl border-slate-300 text-slate-700 hover:bg-slate-50"
              >
                Cancel
              </Button>
              <Button
          ...
          <DialogContent className="sm:max-w-[425px] bg-white rounded-2xl shadow-xl">
            <DialogHeader>
              ...
              <DialogDescription className="text-center text-slate-600 mt-2">
                The student progress report has been updated successfully.
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
              <div className="text-center">
